export const POWER_HEADING_PREFIX = 'What Makes'
export const POWER_HEADING_EM = 'Revolte'
export const POWER_HEADING_SUFFIX = 'Powerful'
export const POWER_DESCRIPTION =
