...
export const useCase2: UseCaseData = {
  slug: 'use-case-2',

  hero: {
    headline: 'Your second use case headline.',
    description: 'Description for use case 2.',
    ctaLabel: 'Get Started',
    ctaHref: '/get-started',
    backgroundImage: '/images/use-cases/use-case-2/hero-desktop.png',
    backgroundImageMobile: '/images/use-cases/use-case-2/hero-mobile.png',
  },

  persona: {
    eyebrow: 'PERSONA',
    headline: 'When scale is the goal,',
    headlineItalic: 'reliability',
    headlineEnd: "can't be an afterthought",
    description:
      "Scaling teams hit bottlenecks not from lack of effort, but from systems that weren't built to grow with them.",
    ctaLabel: 'Learn more',
    ctaHref: '#',
    autoPlayInterval: 4000,
    personas: [
      {
        image: '/images/use-cases/use-case-2/persona-1.png',
        role: 'VP of Engineering',
        problemStatement:
          'You need systems that hold up under pressure—not heroics that paper over fragile architecture.',
        profileBgColor: '#E8D5C4',
        roleBgColor: '#FFF3EC',
        problemBgColor: '#2E1800',
      },
      {
        image: '/images/use-cases/use-case-2/persona-2.png',
        role: 'Platform Engineer',
        problemStatement:
          "You're tired of being the single point of failure for every deployment and environment issue.",
        profileBgColor: '#C4D5E8',
        roleBgColor: '#ECF3FF',
        problemBgColor: '#00182E',
      },
      {
        image: '/images/use-cases/use-case-2/persona-3.png',
        role: 'Engineering Manager',
        problemStatement: 'You want your team focused on product—not on keeping the lights on.',
        profileBgColor: '#D5E8C4',
        roleBgColor: '#F3FFEC',
        problemBgColor: '#0A2E00',
      },
    ],
  },
  howItWorks: {
