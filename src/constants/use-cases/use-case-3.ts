...
export const useCase3: UseCaseData = {
  slug: 'use-case-3',

  hero: {
    headline: 'Your third use case headline.',
    description: 'Description for use case 3.',
    ctaLabel: 'Get Started',
    ctaHref: '/get-started',
    backgroundImage: '/images/use-cases/use-case-3/hero-desktop.png',
    backgroundImageMobile: '/images/use-cases/use-case-3/hero-mobile.png',
  },

  persona: {
    eyebrow: 'PERSONA',
    headline: 'When compliance matters,',
    headlineItalic: 'governance',
    headlineEnd: 'should be built in, not bolted on',
    description:
      "Security and compliance can't be an afterthought. Teams need guardrails that work without slowing down delivery.",
    ctaLabel: 'Learn more',
    ctaHref: '#',
    autoPlayInterval: 4000,
    personas: [
      {
        image: '/images/use-cases/use-case-3/persona-1.png',
        role: 'CISO / Security Lead',
        problemStatement:
          "You need AI-assisted workflows that don't introduce new attack surfaces or audit gaps.",
        profileBgColor: '#C4E8D5',
        roleBgColor: '#ECFFF3',
        problemBgColor: '#001A0D',
      },
      {
        image: '/images/use-cases/use-case-3/persona-2.png',
        role: 'Compliance Officer',
        problemStatement:
          'You want developers to move fast without you needing to review every release manually.',
        profileBgColor: '#E8E4C4',
        roleBgColor: '#FFFBEC',
        problemBgColor: '#1A1600',
      },
      {
        image: '/images/use-cases/use-case-3/persona-3.png',
        role: 'DevOps Lead',
        problemStatement:
          'You need pipelines that enforce policy automatically—not post-hoc audits that slow everything down.',
        profileBgColor: '#D5C4E8',
        roleBgColor: '#F3ECFF',
        problemBgColor: '#0D001A',
      },
    ],
  },
  howItWorks: {
